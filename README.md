...
pixi global install tomtoolkit
```
...
It is possible to list all of the versions of `tomtoolkit` available on your platform:
...
```
pixi search tomtoolkit --channel conda-forge
```
